...
def test_max_content_length():
    """Test of setting max_content_length"""
    expected = 10
    ...
    conf = Config(ConfClass)
    assert conf.max_content_length == expected


def test_max_content_length_invalid():
    """Test of setting invalid max_content_length"""
